...
- **Dialogue** — sparse. Mostly monologue or narration; when present, formal and stagey.
- **Paragraph** — long in the measured opening, fragmenting as the narrative deteriorates.
- **Diction** — elevated, Latinate, ornate. Archaisms and formal constructions. Vocabulary of sensation, disease, perception.
- **Figures** — constrained by the narrator's literalism; he describes sensation precisely rather than reaching for metaphor. Atmosphere from accumulated concrete detail, not imagery.
- **Unusual** — the structure of self-betrayal: building a case for his own rationality with material that convicts him. A single fixated detail — a sound, an eye, a heartbeat — as the spine of the whole piece.

**Writing it:** give the narrator one fixation and route everything through it. Have him insist on his composure. Accelerate as the piece proceeds. Ornate gothic prose alone isn't it — the unreliability is the mechanism.
