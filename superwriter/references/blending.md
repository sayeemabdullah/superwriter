...
2. **Don't average** — averaging produces neutrality. Assign dimensions: rhythm and syntax from one, selection and emotional placement from the other. Interesting blends are lopsided.
3. State to the user in one line which dimensions came from which source.
4. Where the two conflict irreconcilably, pick one. A half-hypotactic sentence is just muddled.
